...
class SignUpMessage {
  public static getMessage(
    ...
    return {
      ...
      html: `Hi there!<br>You recently signed up on gipfeli.io.<br>Please use the following link to activate your account:<br><br><a href="${signUpUrl}">Activate account</a><br><br>Glad to have you here,<br>your gipfeli.io Team`,
    };
  }
}
